            ...
            <div className="container-sm">
                ...
                <div className="row">
                    <div className="col-md-12">
                        <Link to=""><a className="d-grid py-4 my-2 btn btn-secondary" href="#" role="button">20 minutes</a></Link>
                    </div>
                </div>
                <div className='row'>
                    <div class="col-md-12 my-2 btn-group btn-group-toggle" data-toggle="buttons">
                        <label class="btn btn-secondary active form">
                            <input type="radio" name="options" id="option1" autocomplete="off" defaultChecked/> Treble Clef
                        </label>
                        <label class="btn btn-secondary form">
                ...
                <div className='row'>
                    <div className="col-md-6 offset-md-2 my-2">
                        <Link to="/"><a className="d-grid py-3 btn btn-primary" role="button">Play</a></Link>
                    </div>
